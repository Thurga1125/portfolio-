...
const SKILLS = [
  { cat: 'Frontend',    icon: '', items: ['React', 'Angular 17', 'Next.js', 'TypeScript', 'Tailwind CSS', 'ShadCN UI'], grad: 'from-violet-500 to-purple-600' },
  { cat: 'Backend',     icon: '', items: ['Spring Boot', 'Node.js', 'Express', 'Java', 'C#'],                           grad: 'from-blue-500 to-cyan-600' },
  { cat: 'Database',    icon: '', items: ['MongoDB', 'MySQL', 'SQLite', 'Neo4j'],                                       grad: 'from-emerald-500 to-green-600' },
  { cat: 'Tools',       icon: '', items: ['Git', 'Docker', 'Figma', 'CapCut', 'Firebase'],                              grad: 'from-orange-500 to-amber-600' },
  { cat: 'Soft Skills', icon: '', items: ['UI/UX Design', 'Video Editing', 'Leadership', 'Problem Solving'],            grad: 'from-pink-500 to-rose-600' },
]
